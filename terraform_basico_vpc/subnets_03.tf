resource "aws_subnet" "public_subnet_a_03" {
...
resource "aws_route_table_association" "public_subnet_cluster_1a_association_03" {
    subnet_id      = aws_subnet.public_subnet_a_03.id
    route_table_id = aws_vpc.vpc_03.main_route_table_id
}

resource "aws_subnet" "public_subnet_b_03" {
    vpc_id                  = aws_vpc.vpc_03.id
...
resource "aws_route_table_association" "public_subnet_cluster_1b_association_03" {
    subnet_id      = aws_subnet.public_subnet_b_03.id
    route_table_id = aws_vpc.vpc_03.main_route_table_id
}